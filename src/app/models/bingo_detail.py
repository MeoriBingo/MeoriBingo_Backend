from sqlalchemy import Column, Integer, String, ForeignKey, Boolean, DateTime, Date, index
...
class BingoBoard(Base):
    ...
    cells = relationship("BingoCell", back_populates="board", order_by="BingoCell.position")
